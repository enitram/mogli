...
namespace mogli {
   ...
   * @param[in]  reduce_subgraphs   Merge resulting fragments, if one is a subgraph of the other.
   * @return                        False, if timeout occured, true otherwise.
   */
  bool maximal_common_fragments(Molecule &mol1,
                                Molecule &mol2,
